...
public class MapperSqlHelper {
	  ...
	  public static final Class<? extends Annotation> MYBATISREPOSITORY = Table.class;
	  public static final Class<? extends Annotation> MYBATISTABLE = Table.class;
	  public static final Class<? extends Annotation> MYBATISCOLUMN = Column.class;
	  public static final Class<? extends Annotation> MYBATISID = ID.class;
...
//	        } 
	    Field[] files = Student.class.getDeclaredFields();
